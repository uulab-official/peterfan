...
.rail-btn.active{border-color:transparent;background:rgba(110,168,255,.15);box-shadow:none;color:var(--accent);}
...
.rail-btn.active{background:rgba(37,103,189,.11);}
}
