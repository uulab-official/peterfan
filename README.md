...
| Area | Status |
| --- | --- |
| macOS menu-bar app | Four selectable eight-frame runners (cat, dog, rabbit, fox) whose speed follows CPU load, temperature/runner/both styles, popover dashboard, detail window, light/dark mode |
